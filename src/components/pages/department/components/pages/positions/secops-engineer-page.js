	...
	DocPage(
		{
			...
			description: `The SecOps Engineer is a crucial role within the Technical Department, responsible for ensuring the security, compliance, and integrity of DentalQore's systems and applications. This document outlines the expectations, responsibilities, and goals associated with the SecOps Engineer position.`
		},
		[
			...
			Section({ class: 'space-y-4 mt-12' }, [
				...
				Ul({ class: 'list-disc pl-6 space-y-1 text-muted-foreground' }, [
					Li("Develop and implement security policies, procedures, and best practices to protect DentalQore's systems and applications from security threats."),
					...
					Li("Conduct regular security assessments and audits, ensuring that DentalQore's systems and applications comply with industry standards and applicable laws and regulations."),
			...
			Section({ class: 'space-y-4 mt-12' }, [
				...
				Ul({ class: 'list-disc pl-6 space-y-1 text-muted-foreground' }, [
					Li("Ensure the security, compliance, and integrity of DentalQore's systems and applications, protecting sensitive data and maintaining client trust."),
					...
					Li("Contribute to the overall success of the Technical Department and the growth of DentalQore by helping to ensure the secure and compliant operation of the company's systems and applications.")
				])
			])
		]
	)
