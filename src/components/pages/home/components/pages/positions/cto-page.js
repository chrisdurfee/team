		...
		[
			...
			Section({ class: 'space-y-4 mt-12' }, [
				...
				Div({ class: 'flex flex-col space-y-4' }, [
					...
					Div([
						Span({ class: 'text-lg' }, 'Lead the Technical Department: '),
					...
					Div([
						Span({ class: 'text-lg' }, 'Collaborate with stakeholders: '),
					...
					Div([
						Span({ class: 'text-lg' }, 'Build external relationships: '),
					...
					Div([
						Span({ class: 'text-lg' }, 'Ensure scalable and secure infrastructure: '),
					...
					Div([
						Span({ class: 'text-lg' }, 'Technology evangelism: '),
			...
			Section({ class: 'space-y-4 mt-12' }, [
				...
				Div({ class: 'flex flex-col space-y-4' }, [
					Div([
						Span({ class: 'text-lg' }, 'Execute the vision: '),
					...
					Div([
						Span({ class: 'text-lg' }, 'Enhance software quality: '),
					...
					Div([
						Span({ class: 'text-lg' }, 'Develop a high-performing team: '),
					...
					Div([
						Span({ class: 'text-lg' }, 'Deliver technology initiatives: '),
					...
					Div([
						Span({ class: 'text-lg' }, 'Promote security and compliance: '),
